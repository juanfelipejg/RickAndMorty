namespace RickAndMorty.Application.Services.Character
{
    ...
    public class CharacterService : ICharacterService
    {
        ...
        public CharacterService( ICharacterGetter characterGetter, RickAndMortyContext rickAndMortyContext )
        {
        ...
        {
            var characterToUpdate = this.rickAndMortyContext.Characters.Find(id);
